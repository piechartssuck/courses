...
-   <b>Programming and analysis in</b><i style="color:#161618;" class="fab fa-r-project fa-lg"></i> <b>with markup using</b> `\(\LaTeX\)`
...
Made in <i style="color:#3365B3;" class="fab fa-r-project"></i>: [Source code](https://github.com/drabhikroy/Courses/blob/iam/content/en/work/resume-pdf.)
