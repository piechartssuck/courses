...
knitr::include_url("/slides/What%20is%20PE/What-is-PE-pres.html")
```
</div>
...
html_link <- function() {
  paste0("<a href='/slides/What%20is%20PE/What-is-PE-pres.html' target='_blank'>", "<img src='/logos/web-ico.png' alt='Criteria for Evaluations Page' width='35'>", "</a>")
}

pdf_link <- function() {
 paste0("<a href='/slides/What%20is%20PE/What-is-PE-flat.pdf' target='_blank'>", "<img src='/logos/pdf-ico.png' alt='Criteria for Evaluations PDF' width='35'>", "</a>")
}
