...
html_link <- function() {
  paste0("<a href='/slides/Week 11/Slides-Week-11-pres.html' target='_blank'>", "<img src='/logos/web-ico.png' alt='Cohen's Kappa Page' width='35'>", "</a>")
}

pdf_link <- function() {
 paste0("<a href='/slides/Week 11/Slides-Week-11-flat.pdf' target='_blank'>", "<img src='/logos/pdf-ico.png' alt='Cohen's Kappa PDF' width='35'>", "</a>")
}
