...
knitr::include_url("/slides/Survey%20Design/Slides-SurveyDesign-pres.html")
```
</div>
...
html_link <- function() {
  paste0("<a href='/slides/Survey%20Design/Slides-SurveyDesign-pres.html' target='_blank'>", "<img src='/logos/web-ico.png' alt='Sampling presentation' width='35'>", "</a>")
}

pdf_link <- function() {
 paste0("<a href='/slides/Survey%20Design/Slides-SurveyDesign-flat.pdf' target='_blank'>", "<img src='/logos/pdf-ico.png' alt='Sampling presentation PDF' width='35'>", "</a>")
}
