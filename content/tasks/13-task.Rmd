...
html_link <- function() {
  paste0("<a href='/slides/Power%20Analysis/power-analysis-pres.html' target='_blank'>", "<img src='/logos/web-ico.png' alt='PCA presentation' width='35'>", "</a>")
}

pdf_link <- function() {
 paste0("<a href='/slides/Power%20Analysis/power-analysis-flat.pdf' target='_blank'>", "<img src='/logos/pdf-ico.png' alt='PCA presentation PDF' width='35'>", "</a>")
}
