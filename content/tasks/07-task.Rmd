...
dplyr::tibble(
  ...
  description <- c(
    ...
    "<div id='info'><div id='speechbubble' data-hover='CSS'><span style='color:#4682b4'><i class='fa-brands fa-r-project fa-xl'></i></span></div></div>",
    ""
            ),
...
knitr::include_url("/slides/Factorial%20Validity/Basics-and-Buttons-pres.html")
```
</div>
