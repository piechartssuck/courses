...
In some weeks you will be expected to complete an additional R task which are indicated by a `r fontawesome::fa("square", fill = "steelblue")` in the table above. Collectively these serve as the <b>R Survey EDA</b> noted on the [syllabus](/syllabus/#assignments-and-grades).
