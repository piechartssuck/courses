...
inferences <- tibble(
  ...
  Type = c("<i>Frequentist</i> statistician",
 ...
 `What is Random?` = c("<i>Observed data</i>. Any data that has been collected from an experiment",
                       "<i>Population parameters</i>. Any summary number, like an average or percentage, that describes the entire population"),
  
  `Type of Reasoning` = c("<i>Deductive</i> logic",
                "<i>Inductive</i> logic"),
  
  Terminology = c("Common terms like <i>p-value</i>, <i>significant</i>, <i>null hypothesis</i>, and <i>confidence interval</i>",
...
kable(inferences, 
  ...
  row_spec(0:nrow(inferences), extra_css = 'vertical-align: middle !important;', background = "#212121", color = "#ffffff")
