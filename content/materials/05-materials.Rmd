...
knitr::include_url("/slides/Week 5/Slides-Week-5-pres.html")
```
</div>
...
html_link <- function() {
  paste0("<a href='/slides/Week 5/Slides-Week-5-pres.html'>", "<img src='/logos/web-ico.png' alt='Survey Design Page' width='35'>", "</a>")
}

pdf_link <- function() {
 paste0("<a href='/slides/Week 5/Slides-Week-5-flat.pdf'>", "<img src='/logos/pdf-ico.png' alt='Survey Design PDF' width='35'>", "</a>")
}
