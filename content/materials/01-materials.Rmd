...
html_link <- function() {
  paste0("<a href='/slides/Week 1/Slides-Week-1a-pres.html'>", "<img src='/logos/web-ico.png' alt='Survey Design Page' width='35'>", "</a>")
}

pdf_link <- function() {
 paste0("<a href='/slides/Week 1/Slides-Week-1a-flat.pdf'>", "<img src='/logos/pdf-ico.png' alt='Survey Design PDF' width='35'>", "</a>")
}
...
<div class="bigcol">
```{r echo = FALSE, out.width="140%", fig.align='left'}
knitr::include_url("/slides/Week 1/Slides-Week-1b-pres.html")
```
</div>
...
```{r echo = FALSE, fig.align='right'}
html_link <- function() {
  paste0("<a href='/slides/Week 1/Slides-Week-1b-pres.html'>", "<img src='/logos/web-ico.png' alt='Survey Design Page' width='35'>", "</a>")
}

pdf_link <- function() {
 paste0("<a href='/slides/Week 1/Slides-Week-1b-flat.pdf'>", "<img src='/logos/pdf-ico.png' alt='Survey Design PDF' width='35'>", "</a>")
}
