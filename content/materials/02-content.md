...
> Click [here](/slides/Week 2/Slides-Week-2.html){target="_blank"} for a larger version of the presentation.

> Click [here](/slides/Week 2/Slides-Week-2.pdf){target="_blank"} here for a PDF of the presentation.
...
> Click [here](/slides/Week 2/Slides-Week-2R.html){target="_blank"} for a larger version of the presentation.

> Click [here](/slides/Week 2/Slides-Week-2R.pdf){target="_blank"} here for a PDF of the presentation.
