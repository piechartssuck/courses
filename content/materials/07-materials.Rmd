...
html_link <- function() {
  paste0("<a href='/slides/Week 7/Slides-Week-7a-pres.html'>", "<img src='/logos/web-ico.png' alt='Survey Design Page' width='35'>", "</a>")
}

pdf_link <- function() {
 paste0("<a href='/slides/Week 7/Slides-Week-7a-flat.pdf'>", "<img src='/logos/pdf-ico.png' alt='Survey Design PDF' width='35'>", "</a>")
}
...
```{r echo = FALSE, fig.align='right'}
html_link <- function() {
  paste0("<a href='/slides/Week 7/Slides-Week-7b-pres.html'>", "<img src='/logos/web-ico.png' alt='Survey Design Page' width='35'>", "</a>")
}

pdf_link <- function() {
 paste0("<a href='/slides/Week 7/Slides-Week-7b-flat.pdf'>", "<img src='/logos/pdf-ico.png' alt='Survey Design PDF' width='35'>", "</a>")
}
