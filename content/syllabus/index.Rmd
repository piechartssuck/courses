...
You will be introduced to the open source (and free!) statistical programming language [`r fa("r-project", fill = "steelblue")`](https://cran.r-project.org/)&nbsp; later in the term using <a href='https://www.rstudio.com/' target='_blank'>RStudio</a> as the main program to access the language. You can think of R as an engine and RStudio as a car dashboard — R handles all the calculations produces the actual statistics and graphical output, while RStudio provides a nice interface for running R code. Please note that
...
We have a class <a href='https://edp619fall2022.slack.com' target='_blank'>Slack</a> channel where you can poise a question and post as needed. This is the only mode where I have applicable class notifications turned on my devices so please utilize the platform.
