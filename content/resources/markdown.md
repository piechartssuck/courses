...
<th><pre><code>    …or…</code></pre></th>
<th><pre><code>            …to get</code></pre></th>
</tr>
</thead>
<tbody>
<tr class="odd">
...
<tbody>
<tr class="odd">
<td><pre><code>                             Type…                                 |                             …to get                             |</code></pre>
=======================================================================+=================================================================+
<pre>Based on the DAG, the regression model for                       | Based on the DAG, the regression model for                      |
 ...
 `\(\text{Wages} = \beta_0 + \beta_1 \text{Education} + \epsilon\)`.</pre>
<p>| <code>\(\text{Wages} = \beta_0 + \beta_1 \text{Education} + \epsilon\)</code>.</p></td>
</tr>
</tbody>
</table>
