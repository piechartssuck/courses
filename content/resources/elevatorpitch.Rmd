...
tibble(
  ...
  les <- c("Orally",
           "Introduce researchers, intended projects, and their corresponding significance so your audience will want to learn more about it",
          "1 minute (+/- 10 seconds)"),
  
  tes <- c("Orally",
           "Introduce a content area, its significance to the field; report dominant and emergine outcomes from the synthesis so your audience will learn more about the area and its connectivity to a broader picture",
           "2 to 5 minutes"),
          
    abs <- c("Written",
             "Explain a research project and its significance in order to apply for funding (e.g. assistantships, fellowships, scholarships, etc.), present at conferences, publish in journals, or just for kicks",
             "150 to 300 words"),
  
  .name_repair = "minimal"
  
) %>%
  kbl(col.names = c("", "Elevator Pitch", "Elevator Speech", "Abstract"), 
      "html", 
      escape = FALSE,
      align = 'llll') %>%
