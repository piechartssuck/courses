...
This week you have two walkthroughs^[again lucky you!] 

1. included in the [R Task](/modules/06-module/#r-task) download
...
+ Please go and take the [Generic Conspiracist Beliefs Scale](https://openpsychometrics.org/tests/GCBS/){target="_blank"}. 

+ Read this short synopsis on this and other tests to assess what drives conspirators at [Psychology Today](https://www.psychologytoday.com/us/blog/experimentations/201810/what-makes-conspiracy-theorists-tick){target="_blank"}^[I am personally fond of the BSR.]. 
...
This is a very rough and light practical introduction to EFAs. There are many intricacies associated with the methods that we simply cannot cover here due to timing. For example, what to do if you find similar loadings in two or more different factors? negative value for factor loading? are both valid questions beyond the scope of this snapshot look at the area.
