...
.center2[Validity of inferences about whether observed covariation between `X` (treatment/cause) and `Y` (outcome/effect) reflects a causal relationship from `X` to `Y` as those variables were manipulated or measured]
