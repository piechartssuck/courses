...
<center>
<img src="img/variance_card.png" height="500px" style="background-color:#212121;"/>
</center><br><br>

<p align="center">
<iframe width="560" height="315" src="https://www.youtube.com/embed/SzZ6GpcfoQY" title="StatQuest Pearson's Correlation, Clearly Explained!!!" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</p>
]

.pull-right[
.bg-washed.b--dark-green.ba.bw2.br3.shadow-5.ph4.mt5[
**Correlations** gives you an idea of the strength or weakness of the relationship between two variables. In a survey where each item is set to measure a single construct, these are essentially the applicable questions.<br><br>

<img src="img/correlation_card.png" height="500px" style="background-color:#212121;"/>
</center><br><br>

<p align="center">
<iframe width="560" height="315" src="https://www.youtube.com/embed/xZ_z8KWkhXE" title="StatQuest Pearson's Correlation, Clearly Explained!!!" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</p>
]
...
# Principle Component Analysis (PCA) - Steps in a Nutshell

The basic idea of a PCA can be broken into two steps

--

1. Locate the directions, or *components*, in a data set with high variance<br>
<center>
<img src="img/pc_card.png" height="500px" style="background-color:#212121;"/>
</center>

--

2. Find a limited number of components with high variance that in aggregate can explain most of the overall variance in the data set<br>
<center>
<img src="img/pca_card.png" height="500px" style="background-color:#212121;"/>
</center>
...
.pull-left[
***Dimensionality*** - The number of input variables, or *features* in a dataset. In a spreadsheet, you can think of these as the column names.<br>
<center>
<img src="img/dimensionality_spreadsheet.png" height="500px" style="background-color:#212121;"/>
</center>
]
...
.pull-right[
+ ***Dimensionality Reduction*** - Statistical techniques used to reduce the number of input variables.<br>
<center>
<img src="img/dimensionality_spreadsheet.png" height="500px" style="background-color:#212121;"/>
</center>
]
