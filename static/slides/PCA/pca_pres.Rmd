...
```{r pc1plot, echo=FALSE, out.width="60%", fig.align = 'center'}
...
.panel[.panel-name[Look]
```{r pcplot2, echo=FALSE, out.width="60%", fig.align = 'center'}
...
.panel[.panel-name[Look]
```{r pcplot3, echo=FALSE, out.width="60%", fig.align = 'center'}
...
.panel[.panel-name[Look]
```{r pcplot4, echo=FALSE, out.width="60%", fig.align = 'center'}
...
.pull-right[
```{r tsneplot, echo=FALSE, warning=FALSE, message=FALSE}
TSNE
```
]
...
```{r tsneanim, echo=FALSE, message = FALSE, warning = FALSE, results = FALSE}
## tSNE dimensions
tsne_dims <- 
...
.pull-left[
```{r pc12plot, echo=FALSE, warning=FALSE, message=FALSE}
PCA12
```
]

.pull-right[
```{r pc34plot, echo=FALSE, warning=FALSE, message=FALSE}
PCA34
```
]
